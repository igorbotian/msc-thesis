\Paragraph{Общие слова}
\TODO{Как данная информация может быть использована при анализе проекта}.
\Paragraph{Цели}
\Sentence
...
\Sentence
Согласно спецификации \PeerHood, к ним относятся следующие \Reference{PeerHoodSpecification}:
\begin{itemize}
...
\Sentence
К функциональным относятся следующие \Reference{PeerHoodSpecification} 
