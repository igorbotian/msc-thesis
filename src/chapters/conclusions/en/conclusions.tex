...
%
The \IT{PeerHood} software was examined in this work. 
%
...
%
The next step to reach the goal of the research was to study the \IT{PeerHood} concept. 
%
The goals, requirements and architecture of the software were examined. 
%
The step was on of the practical parts of the research and was required to further \IT{PeerHood} security analysis. 

\Paragraph{PeerHood security analysis}
%
Finally, the last step provided the main practical part of the research. 
%
The \IT{PeerHood} analysis was made by performing of risk-based and property-based software security methods, dynamic and static analysis of the project, source code revision as well. 
%
The results of the analysis showed that \IT{PeerHood} has security vulnerabilitie influenced the integrity and confidentiality of data transferred between devices and the availability proper operating of the project. 
%
Therefore \IT{PeerHood} cannot be treated as a secure and fault-tolerant software. 
...
%
However, only well-known and most frequent software security vulnerabilities were searching in \IT{PeerHood} during making the analysis. 
%
...
%
The results of the research are planned to be used in further development of \IT{PeerHood}. 
%
...
%
Also, it can be considered as the first step towards taking into account of secrurity in further development of \IT{PeerHood}. 
