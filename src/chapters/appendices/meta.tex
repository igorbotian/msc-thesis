...
%
\newpage
\TheAppendix{PeerHood API}{peerhood_api}
\IncludeAppendix{peerhood_api}
%
\newpage
\TheAppendix{Cppcheck Output}{cppcheck_output}
\IncludeAppendix{cppcheck_output}
%
\newpage
\TheAppendix{RATS Output}{rats_output}
\IncludeAppendix{rats_output}
%
\newpage
\TheAppendix{Valgrind Output}{valgrind_output}
\IncludeAppendix{valgrind_output}
%
\newpage
\TheAppendix{Helgrind Output}{helgrind_output}
