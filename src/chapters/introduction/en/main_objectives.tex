...
%
The \T{subject} of the research is \The PeerHood networked environment, based on the concept of peer-to-peer communication between \Abbreviation{PTD}'s in a mobile environment \Reference{PeerToPeerNeighborhood}. 
%
