...
%
Private user data security depends on a number of factors, both human and technical \Reference{Winograd2008}. 
%
...
%
The \T{object} of the research is related to security vulnerabilities of software that is utilized by a user on his \Abbreviation{PTD} to perform communication operations. 
%
The \T{subject} of the research is PeerHood networked environment, based on the concept of peer-to-peer communication between \Abbreviation{PTD}'s in mobile environment \Reference{PeerToPeerNeighborhood}. 
%
