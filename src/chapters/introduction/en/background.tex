...
%
Whereas each user had to use several devices, mobile phone and \Abbreviation{PDA}, to perform both of these operations. 
%
...
%
For example, support of \IT{Bluetooth} \WebSite{Bluetooth} technology by mobile devices increased popularity of local interactions between users. 
%
...
%
Clear examples are utilization of the same software platform on different mobile devices (\IT{Apple iOS} \WebSite{iOS}, \IT{Google Android} \WebSite{Android}) as well as orientation of software platform manufacturers to support one unified user interface on different devices (\IT{Microsoft Metro} \WebSite{MetroUI}, \IT{Ubuntu Unity} \WebSite{Unity}). 
%
