...
\Paragraph{Tools}
%
The practical part of the work is performed in \IT{GNU/Linux} \WebSite{Linux} environment. 
%
...
%
PeerHood is implemented in \IT{C++} programming languange \Reference{CppStandard2003} and interacts with \Abbreviation{OS} through \IT{Qt} framework \WebSite{Qt}. 
%
