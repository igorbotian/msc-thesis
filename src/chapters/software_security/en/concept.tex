...
%
Protection of these properties is known as CIA Triad, that is represented on \ReferenceToFigure{software_security_cia_triad}. 
%
...
%
If one CIA Triad element is not taked into account, this fact may cause serious complications \Reference{FIBSPUB199}. 
%
