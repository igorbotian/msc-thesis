...
%
Атакой на \RussianAbbreviation{ПО} называется \EnglishText{an intentional act by which an entity attempts to evade security services and violate the security policy of a system} \Reference{RFC4949}.
%
Лицо, которое проводит такого рода атаки, называется \Emphasis{злоумышленником} \Reference{Stallings2008}. 
%
...
%
То, что является целью проведения атаки для злоумышленника, называется \Emphasis{\EnglishText{asset}}. 
%
...
%
По своей природе атаки делятся на четыре вида: перехват, модификация, фальсификация ивмешательство \Reference{Talukder2007}. 
%
...
%
Эксплойты всегда направлены на использование злоумышленником какого-либо дефекта безопасности, который содержится в атакуемом \RussianAbbreviation{ПО}. 
