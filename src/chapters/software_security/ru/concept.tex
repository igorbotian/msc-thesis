...
%
Согласно Кембриджскому словарю философии, информация является объективным понятием и связана с такими операциями, как формирование, передача, хранение и др. \Reference{CambridgeDictionary1999}.
%
...
%
Защита данных свойств известна как \Emphasis{\EnglishText{CIA Triad}}.
%
Она изображена на \ReferenceToFigure{software_security_cia_triad}. 
%
Кроме указанных трёх свойств, в некоторых литературных источниках также указываются достоверность, отслеживаемость, невозможность отказа от авторства и надёжность \Reference{ISO17799}. 
...
%
Если при обеспечении безопасности хотя бы один элемент \EnglishText{CIA Triad} не учитывается, то это может привести к серьёзным последствиям \Reference{FIBSPUB199}.
%
...
%
Для того, чтобы избежать перечисленных выше проблем, применяются различные способы обеспечения безопаности.
%
...
%
В данной работе рассматривается только программно-технический способ обеспечения безопасности информации.
%
Он тесно связан с понятием компьютерной безопасности.

\Paragraph{Компьютерная безопасность}
%
Согласно RFC 4949, компьютерная безопасность - это \EnglishText{the protection afforded to an automated information system in order to attain the applicable objectives of preserving the integrity, availability and confidentiality of information system resources (includes hardware, software, firmware, information/data, and telecommunications)} \Reference{RFC4949}.
%
...
%
МкГроу считает, что программное обеспечение является центральным и наиболее критичным аспектом компьютерной безопасности \Reference{McGraw2006}. 
%
Идея безопасности \RussianAbbreviation{ПО} заключается в том, чтобы \RussianAbbreviation{ПО} смогло корректно выполнять свои функции под воздействием атаки со стороны злоумышленника \Reference{McGrawArticle2004}.
%
