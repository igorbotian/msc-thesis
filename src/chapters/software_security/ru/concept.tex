...
%
Понятие \Important{информационная безопасность} означает ''защита информации и информационных систем от несанкционированного доступа, использования, раскрытия, изменения или уничтожения'' 
