...
%
In this case the revision is performed sequentially and involves the following steps: goals of revision are established, static analysis tools are utilized, then accoring to the reports of their work source code revision is performed itself, found errors are eliminated \Reference{Chess2007}. 
