...
%
\IT{ITS4} and \IT{Splint} are intended to search of known vulnerabilities specific to \IT{C} and \IT{C++} programming languages, for example, buffer overflow, format function vulnerabilities, and others (see \ReferenceToSection{software_security_vulnerabilities_format_strings}). 
