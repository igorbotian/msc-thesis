...
% BACKGROUND
% =================================================================================================
\nextparagraph{Background}
\todo{Background}
% =================================================================================================
% MOTIVATION
% =================================================================================================
\nextparagraph{Motivation}
\todo{Motivation}
% =================================================================================================
% OBJECTIVES/GOALS
% =================================================================================================
\subsectiontitle{Objectives}
\todo{Objectives}
...
% =================================================================================================
\subsectiontitle{Scope and delimitations}
\todo{Scope and deliminations}
\begin{suggestions}
	\begin{itemize}
		\item Упомянуть, что не сделано окончательно в данной работе
	\end{itemize}
\end{suggestions}
%
\begin{comment}
...
% =================================================================================================
\subsectiontitle{Structure of the thesis}
...
I.e. start by motivating why you are doing what you are doing, find what others have done, and write this down very carefully. This section sets the main basis for all remaining chapters. Trust me, doing this first will benefit your work!
...
articles (journals only), e.g. from IEEE and Elsevier (these articles are often found with Google as well, but you may need library services to access the articles).
